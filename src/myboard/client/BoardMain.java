...
public class BoardMain {
	public static void main(String[] args) {
		...
		case 2:
			...
			if(cnt>0) System.out.println("게시글 등록 성공");
		...
		case 3:
			...
			if(!(num.isEmpty())) vo.setBrdNo(Integer.parseInt(num));
		...
		case 4:
			...
			cnt = service.edit(vo);
			if(cnt>0) System.out.println("게시글 편집 성공");
			else System.out.println("실패");
			break;
		...
		case 5:
			...
			if(cnt>0) System.out.println("게시글 삭제 성공");
			else System.out.println("실패");
			break;
		}
	}
